...
export default function CustomizePage() {
  return (
    <div className="pt-20 min-h-screen flex flex-col">
      {/* Header */}
      <div className="bg-mist-band px-4 sm:px-6 py-8 border-b border-bloom/12">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div className="p-2 rounded-xl bg-bloom/10">
              <Sparkles size={20} className="text-bloom-dark" />
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <motion.div
              ...
              transition={{ delay: 0.2 }}
              className="petal-card p-5 rounded-3xl flex flex-col"
