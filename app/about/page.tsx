...
const team = [
  { name: "Valentina Mora", role: "Fundadora & Directora", emoji: "👩‍🎨" },
  { name: "Isabella Ramos", role: "Jefa de Diseño Floral", emoji: "👩‍🌾" },
  { name: "Daniela Vega", role: "Artesana Principal", emoji: "🧑‍🍳" },
];
...
export default function AboutPage() {
  return (
    <div className="min-h-screen">
      {/* Hero */}
      <div className="pastel-band relative pt-32 pb-20 px-4 text-center overflow-hidden">
        <motion.div
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {values.map((v, i) => (
              <motion.div
                ...
                whileHover={{ y: -6 }}
                className={`clay-card ${v.color} p-6 rounded-3xl text-center`}
              >
