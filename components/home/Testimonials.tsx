...
const testimonials = [
  {
    name: "María Fernanda", location: "Bogotá", emoji: "👩‍🦱", rating: 5,
    ...
    product: "Ancheta Wellness", color: "petal-card-violet",
  },
  {
    name: "Camila Torres", location: "Medellín", emoji: "👩", rating: 5,
    ...
    product: "Ancheta Amor Eterno", color: "petal-card-peach",
  },
  {
    name: "Santiago Ruiz", location: "Cali", emoji: "👨‍🦰", rating: 5,
    ...
    product: "Set Spa Completo", color: "petal-card-mint",
  },
  {
    name: "Valeria Gómez", location: "Bucaramanga", emoji: "👩‍🦲", rating: 5,
    text: "Las flores preservadas son hermosas, parecen recién cortadas. Ya compré 3 veces y siempre superan mis expectativas.",
    product: "Corona de Flores Eternas", color: "petal-card-sky",
  },
  {
    name: "Andrés Castro", location: "Barranquilla", emoji: "👨", rating: 5,
    ...
    product: "Ancheta Baby Shower", color: "petal-card-pink",
  },
];
              ...
              <div className={`petal-card ${t.color} p-6 h-full flex flex-col`}>
                ...
                <div className="flex items-center gap-3 mt-5 pt-4 border-t border-ink/8">
                  ...
                  <div>
                    ...
                    <p className="text-ink/40 text-xs">{t.location} · {t.product}</p>
                  </div>
                </div>
              </div>
            </motion.div>
